...
#include "stanExports_bayesian_biomarker_test_tissue.h"

RCPP_MODULE(stan_fit4bayesian_biomarker_test_tissue_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bayesian_biomarker_test_tissue")
