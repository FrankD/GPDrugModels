...
#include "stanExports_bayesian_meta_analysis_tissue.h"

RCPP_MODULE(stan_fit4bayesian_meta_analysis_tissue_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bayesian_meta_analysis_tissue")
