...
namespace model_bayesian_biomarker_test_tissue_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bayesian_biomarker_test_tissue");
    reader.add_event(33, 31, "end", "model_bayesian_biomarker_test_tissue");
    return reader;
}
#include <stan_meta_header.hpp>
class model_bayesian_biomarker_test_tissue : public prob_grad {
private:
        int N;
        ...
        vector_d bm;
public:
    model_bayesian_biomarker_test_tissue(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bayesian_biomarker_test_tissue_namespace::model_bayesian_biomarker_test_tissue";
    ...
    ~model_bayesian_biomarker_test_tissue() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bayesian_biomarker_test_tissue_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_bayesian_biomarker_test_tissue";
    }
...
typedef model_bayesian_biomarker_test_tissue_namespace::model_bayesian_biomarker_test_tissue stan_model;
#endif
